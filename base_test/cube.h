...
public:
	...
	// Фигура при вызове конструктора кубика передает ему результат работы функций-правил раунда
...
private:
	int digit; //! IDEA: число в кубике - до трехзначного, в том числе float? - для вариантов: 2.5  0.7  и т.п. ????
	RGBcolor color; // цвет
