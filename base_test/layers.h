...
{
public:
	// двумерный массив всего стакана - указателей на кубики
	...
	//! Возможен перенос заполнения слоев из предыдущего раунда! - зависит от правила раунда, или некое случайное заполнение в начале раунда
