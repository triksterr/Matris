...
class Round
{
	// Параметры и правила раунда
	// roundSettings - настройки и правила раунда
	// roundState - текущее состояние раунда - возможно, не нужно (все параметры и правила раунда хранятся в roundSettings)
