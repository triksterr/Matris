...
public:
	...
	// Заргузка настроек
	//! При расхождении версий программы и файла настроек (в обе стороны) - искать бэкапы с подходящей версией и предлагать загрузить их, сделав автоматически бэкап текущих настроек.
	//! Искать самый свежий бэкап с текущей версией. При успешной загрузке - удалять все бэкапы с этой версией и перезаписывать основной. Если нет - этот удалять  и, пробовать загрузть чуть более старый. Если ни один не получается загрузить - оставляем текущие настройки.
